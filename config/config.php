...
$GLOBALS['TL_CSS'][] = 'system/modules/emoji/assets/css/emoji.css';
...
$GLOBALS['TL_HOOKS']['parseFrontendTemplate'][] = array('Emoji', 'parseFrontendTemplate');
$GLOBALS['TL_HOOKS']['replaceInsertTags'][] = array('Emoji', 'replaceInsertTags');
$GLOBALS['TL_HOOKS']['processFormData'][] = array('Emoji', 'processFormData');
